...
base_url = 'https://api.bilibili.com/pgc/season/index/result?st=2&order=2&area=-1&style_id=-1&release_date=-1&season_status=-1&sort=0&'
...
def down_load(content,page):
    with open('bilibili_movie'+str(page)+'.json','w',encoding='utf-8') as fp:
        fp.write(content)
